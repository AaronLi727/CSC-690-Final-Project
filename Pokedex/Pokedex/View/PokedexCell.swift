...
class PokedexCell : UICollectionViewCell
{
    ...
    var pokemon: Pokemon?
    {
        didSet
        {
            nameLabel.text = pokemon?.name //displays name
    ...
    lazy var nameContainerView: UIView = //Name Container Within Image View
    {
        let view = UIView()
    ...
    let nameLabel: UILabel = //String within Name Container (Text)
    {
        let label = UILabel()
