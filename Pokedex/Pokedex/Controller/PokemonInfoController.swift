...
class PokemonInfoController: UIViewController {
    ...
    var pokemon: Pokemon? {
        didSet {
            ...
            pokemon?.evoArray?.forEach({ (pokemon) in
                print(pokemon.name)
            })
    ...
    func configureViewComponents() {
        ...
        infoView.anchor(top: infoLabel.bottomAnchor, left: view.leftAnchor, bottom: nil, right: view.rightAnchor, paddingTop: 8, paddingLeft: 0, paddingBottom: 0, paddingRight: 0, width: 0, height: 160)
